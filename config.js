...
var config = {    
    ...
    title: '4871 policies and 800 cities - How city actions shaped the pandemic in America - and how the pandemic shaped them',
    ...
    description: "Bloomberg Philanthropies, along with the NLC created the COVID-19 local action tracker. The data in this Tracker reflects how communities across the country jumped into action to address community needs and learn from one another.<br></br>Unlike most other countries,the United States did not have a unified national strategy to combat COVID-19.</br>The federal structure of the US government meant that state and local officials were in charge of much of the pandemic response. Yet, federal governments, and to a lesser extent state governments, received the vast majority of media coverage for their actions.<br></br> <b>How Local Actions shaped Recovery</b><br> As the pandemic progressed to become a part of everyday life, higher infection rates - ‘waves of the pandemic’ - occurred at different time periods for different cities. With a smaller focus area, a better intuition about the status quo, prompt actions by local leaders have not only helped flatten the curve, but also ensure that disadvantaged populations received equitable access to treatment, testing and other resources. <br></br> The American Rescue Plan Act was introduced to speed up the country's recovery from the economic and health effects of the COVID-19 pandemic. With no fixed playbook that they required to follow, Cities received a unique opportunity to spend their stimulus dollars. Through our analysis, we’ve found that a decentralised response here has been a huge asset to cities. Often overlooked small cities have often struggled to find adequate funding to replace and rebuild their critical infrastructure. Infrastructure programs in the past have required cities to match grants - which smaller cities couldn’t afford without going over budget - like the TIGER program and other infrastructure grants after the 2008 recession.<br></br>Representing large amounts of policy data can be challenging - The qualitative nature of policies means that one can’t solely rely on counts or frequencies of policies to tell a story.<br></br> Below is my attempt to visualise how almost 5000 policies from 800 distinct cities evolved with the pandemic.",
