async function drawLineChartPrev1() {
  // 1. Access data
  ...
  const wrapper = d3.select("#wrapperTWO")
  .append("center")
    .append("svg")
  ...
  const xAxisGenerator = d3.axisBottom()
    ...
    .tickFormat(function(date){
      if (date > Date.parse("July 12, 2020") && date < Date.parse("August 12, 2020")){
        ...
        return d3.timeFormat("Dec '20")(date);
    }
    else if (date > Date.parse("November 12, 2020") && date < Date.parse("Dec 12, 2020")){
      return d3.timeFormat("Dec '20")(date);
  }
  else if (date > Date.parse("June 12, 2021") && date < Date.parse("July 12, 2021")){
    return d3.timeFormat("Jul '21")(date);
  }
    else {
        return d3.timeFormat('')(date);
      }
