async function drawThirdLegend() {
    ...
    const wrapper = d3.select("#wrapperTHIRDleg")
    .append('center')
    .append("svg")
...
if (window.innerWidth < 1025){
    ...
    const legendCircleCases = legendGroup.append("circle").attr("cx",85).attr("cy",18).attr("r", 3).style("fill", "red")
    ...
    legendGroup.append("text").attr("x", 91).attr("y", 18).text("Prevention Policies").style("font-size", "10px").attr("alignment-baseline","red")  
    legendGroup.append("text").attr("x", 36).attr("y", 38).text("Correlation between Prevention Policies and Cases").style("font-size", "10px").attr("alignment-baseline","middle")  
}
else {
    ...
    legendGroup.append("text").attr("x", 36).attr("y", 18).text("Cases").style("font-size", "10px").attr("alignment-baseline","middle")
    legendGroup.append("text").attr("x", 91).attr("y", 18).text("Prevention Policies").style("font-size", "10px").attr("alignment-baseline","middle")  
    legendGroup.append("text").attr("x", 36).attr("y", 38).text("Correlation between Prevention Policies and Cases").style("font-size", "10px").attr("alignment-baseline","middle")  
}
